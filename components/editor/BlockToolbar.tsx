...
import {
  Type, AlignLeft, Image, Video, HelpCircle, ChevronDown,
  List, ListOrdered, Quote, Lightbulb, Minus, Plus
} from 'lucide-react';
...
export function BlockToolbar() {
  ...
  return (
    <div className="relative">
      ...
      {open && (
        <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 bg-white rounded-xl shadow-lg border border-gray-100 p-3 z-10 w-80">
